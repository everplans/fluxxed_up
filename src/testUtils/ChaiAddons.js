export default function (chai, utils) {
  ...
  Assertion.addMethod('informRegisteredStore', function(store) {
    ...
    needCallback.assert(typeof done === 'function',
                        "expected done callback to be specified. Use 'eventually(done)' in the expect chain.")
    ...
    function resolve(data) {
      ...
      if (data) {
        ctx.assert(
          data.foo === mockPayload.foo, // Make sure we've heard from the store
