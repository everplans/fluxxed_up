...
function bindResources(Component, resources) {
  ...
  resourceConfigs.forEach(function (resourceConfig) {
    ...
    if (!resourceStore) resourceStore = _Container2.default.registerStore(resourceName, (0, _StorePrototype2.default)(actionType));
      ...
      bootObjects.forEach(function (bootObject) {
        ...
        switch (bootObject.resourceType) {
          ...
          default:
            ...
            (0, _invariant2.default)(bootObject.resourceType, '`bootObject.resourceType` is unknown or undefined.');
        }
